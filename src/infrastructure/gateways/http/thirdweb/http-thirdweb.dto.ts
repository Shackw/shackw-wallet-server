...
// === Response Schemas ====
export const ThirdwebSearchContractEventsResponseDtoSchema = v.object({
  result: v.object({
    events: v.array(
      v.object({
...
// === Request DTOs ====
export type ThirdwebSearchContractEventsRequestDto = {
  chainId: number;
...
// === Response DTOs ====
export type ThirdwebSearchContractEventsResponseDto = v.InferOutput<
