...
import type { MoralisSearchTransfersQuery } from "@/application/ports/http/moralis-api.gateway.port";
...
// === Response Schemas ====
export const MoralisSearchTransfersResponseExternalSchema = v.object({
...
// === Request Externals ====
export type MoralisSearchTransfersRequestExternal = {
  wallet: Address;
  params: {
...
// === Response Externals ====
export type MoralisSearchTransfersResponseExternal = v.InferOutput<typeof MoralisSearchTransfersResponseExternalSchema>;
