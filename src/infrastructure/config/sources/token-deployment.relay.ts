...
export type TokenDeploymentRelayEntry = {
  tokenSymbol: Token;
  chainKey: Chain;
...
export type TokenDeploymentRelay = Partial<Record<`${Token}:${Chain}`, TokenDeploymentRelayEntry>>;
...
} as const satisfies TokenDeploymentRelay;
